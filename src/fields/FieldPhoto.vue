<template lang="pug">
	<div class="wrapper">
		<input type="text" class="form-control link" v-show="schema.hideInput !== true" v-model="wrappedValue" :autocomplete="schema.autocomplete" :disabled="disabled" :readonly="schema.readonly">
